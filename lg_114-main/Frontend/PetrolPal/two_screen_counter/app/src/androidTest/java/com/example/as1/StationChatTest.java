...
public class StationChatTest {
    ...
    public void stationChatTest() {
        ...
        ViewInteraction materialButton3 = onView(
                allOf(withId(R.id.chatBtn), withText("Chat"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.et2),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("message"), closeSoftKeyboard());
